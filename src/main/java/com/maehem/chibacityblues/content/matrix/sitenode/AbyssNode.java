...
import com.maehem.chibacityblues.content.sites.AbyssSite;
 ...
 * @author mark
 */
public class AbyssNode extends MatrixNode {

    private final MeshView base = new MeshView(new ObjTriangleMesh(
            AbyssNode.class.getResourceAsStream("/content/matrix/core/heatsink-1-base.obj")
    ));
    private final MeshView neck = new MeshView(new ObjTriangleMesh(
            AbyssNode.class.getResourceAsStream("/content/matrix/core/heatsink-1-neck.obj")
    ));
    private final MeshView top = new MeshView(new ObjTriangleMesh(
            AbyssNode.class.getResourceAsStream("/content/matrix/core/heatsink-1-top.obj")
    ));
    
    public AbyssNode(MatrixSite site, double size) {
        super(site, size);     
        ...
        // Finally set the BBS Site for terminal
        site.setTerminal(AbyssSite.class);
