 ...
 */
public class MaasBiolabsVignette extends Vignette {

    private static final int ROOM_NUMBER = 9;
    //public  static final String PROP_NAME = "body-shop";
    private static final String CONTENT_BASE = "/content/vignette/maas-biolabs/";
    ...
    public  static final Point2D PLAYER_START = new Point2D(0.8, 0.86);
